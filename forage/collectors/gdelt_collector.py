...
def main() -> int:
    ...
    log_run(DB_PATH, "gdelt_collector", "success",
            records_in=stats["inserted"] + stats["skipped"],
            records_out=stats["inserted"], duration_s=elapsed,
            detail={"skipped": stats["skipped"], "errors": stats["errors"]})
    return 0
