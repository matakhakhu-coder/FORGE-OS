...
def apply_relationship_schema_patch(db_path = str(Path(__file__).resolve().parent.parent / "database.db")):
    """
...
def apply_graph_schema_patch(db_path = str(Path(__file__).resolve().parent.parent / "database.db")):
    """
